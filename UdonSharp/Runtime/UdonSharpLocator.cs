...
namespace UdonSharp.Updater
{
    ...
    {
        private const string LOCATOR_GUID = "de16ec4337e023649b01c85475dc06f9";
        private const string DEFAULT_INSTALL_PATH = "Packages/com.logiccuteguy.lcgudonsharp/UdonSharp";
        ...
        public static string InstallPath 
        {
            get
            {
                ...
                string locatorPath = AssetDatabase.GUIDToAssetPath(LOCATOR_GUID);
                _cachedInstallLocation = string.IsNullOrEmpty(locatorPath)
                    ? DEFAULT_INSTALL_PATH
                    : Path.GetDirectoryName(locatorPath);
                return _cachedInstallLocation;
            #else
